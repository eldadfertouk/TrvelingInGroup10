...
public class RecyclerAdapterTravelerFragment extends RecyclerView.Adapter<RecyclerAdapterTravelerFragment.ViewHolder> {
    private ArrayList<Traveler>arrayList;
    private Context mContext;
    public static int position;

    public RecyclerAdapterTravelerFragment(ArrayList<Traveler>arrayList, Context context){
